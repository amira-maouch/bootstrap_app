...
interface LoginSelf extends HeronSelfBase {
  ...
  getChild(alias: "@personaEditor"): EgretCoreDivInstance;
  getChild(alias: "@personaEditorName"): EgretCoreTextInstance;
  getChild(alias: "@personaEditorDesc"): EgretCoreTextInstance;
  getChild(alias: "@personaViewer"): EgretCoreDivInstance;
  getChild(alias: "@personaViewerName"): EgretCoreTextInstance;
  getChild(alias: "@personaViewerDesc"): EgretCoreTextInstance;
